...
class MCPClient:
    ...
    async def get_tools(self) -> list[dict[str, Any]]:
        ...
        # list_tools() returns ListToolsResult; the list of Tool is result.tools.
        # Convert each MCP Tool to DIAL/OpenAI format: {"type": "function", "function": {name, description, parameters}}
        tools = [
            {
                "type": "function",
                "function": {
